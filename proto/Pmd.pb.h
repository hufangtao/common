...
#ifndef PROTOBUF_INCLUDED_Pmd_2eproto
#define PROTOBUF_INCLUDED_Pmd_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_Pmd_2eproto 
...
template <> struct is_proto_enum< ::PlatPmd::PlatCommand> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PlatPmd::PlatCommand>() {
  return ::PlatPmd::PlatCommand_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_Pmd_2eproto
